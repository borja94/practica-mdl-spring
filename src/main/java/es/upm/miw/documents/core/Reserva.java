...
public class Reserva {
    ...
    public Reserva(String id ,String nombreHotel , String nombreUsuario , Date fecha , String Hora) {
        super();
        this.id = id;
    ...
    public Reserva(String nombreHotel , String nombreUsuario , Date fecha , String Hora) {
        super();
        this.nombreHotel = nombreHotel;
        this.nombreUsuario = nombreUsuario;
        this.fecha = fecha;
